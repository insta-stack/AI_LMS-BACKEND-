...
const announcementRoutes = require('../server/announcements.js');
...
try {
  const leavesRoutes = require('../server/leaves.js');
...
try {
  const attendanceRoutes = require('../server/attendance.js');
...
try {
  const subjectsRoutes = require('../server/subjects.js');
...
try {
  const timetableRoutes = require('../server/timetable.js');
...
try {
  const storeRoutes = require('../server/store.js');
